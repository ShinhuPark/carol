...
public class CarolEntity extends AnimalEntity {
    ...
    public CarolEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.1, (stack) -> stack.isIn(ItemTags.CAT_FOOD), false));

        //this.goalSelector.add(2, new TemptGoal(this, 1.25D, Ingredient.ofItems(ModItems.TAP_NOTE), false));
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        ...
        //CarolVariant variant = Util.getRandom(CarolVariant.values(), this.random);
